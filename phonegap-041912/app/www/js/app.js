...
(function($,undefined){
    ...
    var $uploadImage, $success, $error, $messages, $form, $imageName, validator,
        serverPath = 'http://notconf-contest.nodejitsu.com:80/add-entry',
        token = {token: 'ZzP5jJSWknXiZ88Wl5gXJcRdK7KBWE'},
        nativeControls = window.plugins.nativeControls;
    
    function setNativeContols() {
        nativeControls.createToolBar();
        nativeControls.createToolBarItem("camera", "Camera", "UIBarButtonSystemItemCamera", {"onTap": getPicture});
        nativeControls.showToolBar();
        
        nativeControls.createTabBar();
        nativeControls.createTabBarItem("submit", "Submit", "", {"onSelect": function() { $form.submit(); }});
        nativeControls.createTabBarItem("reset", "Reset", "", {"onSelect": formReset});
        nativeControls.showTabBar();
        nativeControls.showTabBarItems("submit", "reset");
    }
